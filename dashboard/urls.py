...
from .views import (
    ...
    # Categories
    CategoryListView, CategoryDetailView,ShippingRateDetailView,
...
DeleteOrderView,ShippingRateListView,BulkShippingRateView,
    # Orders
...
urlpatterns = [
     ...
     path('shipping-rates/',         ShippingRateListView.as_view()),
     path('shipping-rates/bulk/',    BulkShippingRateView.as_view()),
     path('shipping-rates/<int:pk>/', ShippingRateDetailView.as_view()),
